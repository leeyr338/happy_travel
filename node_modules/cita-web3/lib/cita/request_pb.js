...
proto.Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    blockNumber: jspb.Message.getFieldWithDefault(msg, 2, false),
    blockByHash: jspb.Message.getFieldWithDefault(msg, 3, ""),
    blockByHeight: jspb.Message.getFieldWithDefault(msg, 4, ""),
    transaction: msg.getTransaction_asB64(),
    height: jspb.Message.getFieldWithDefault(msg, 6, 0),
    peercount: jspb.Message.getFieldWithDefault(msg, 7, false),
    ...
    transactionCount: jspb.Message.getFieldWithDefault(msg, 11, ""),
    code: jspb.Message.getFieldWithDefault(msg, 12, ""),
    newFilter: jspb.Message.getFieldWithDefault(msg, 13, ""),
    newBlockFilter: jspb.Message.getFieldWithDefault(msg, 14, false),
    uninstallFilter: jspb.Message.getFieldWithDefault(msg, 15, 0),
    filterChanges: jspb.Message.getFieldWithDefault(msg, 16, 0),
    filterLogs: jspb.Message.getFieldWithDefault(msg, 17, 0),
...
proto.BatchRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNewTxRequestsList();
  if (f.length > 0) {
...
/**
 * @param {!proto.Request=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Request}
 */
proto.BatchRequest.prototype.addNewTxRequests = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Request, opt_index);
};
